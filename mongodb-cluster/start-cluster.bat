...
mongosh --port 27019 --eval "try { rs.initiate({ _id: 'cfgRS', configsvr: true, members: [{ _id: 0, host: 'localhost:27019' }, { _id: 1, host: 'localhost:27021' }, { _id: 2, host: 'localhost:27022' }] }); print('Config RS initialized'); } catch(e) { print('Config RS already exists or error:', e); }" --quiet
