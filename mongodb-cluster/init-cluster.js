...
print("\n2. Initializing Shard 1 Replica Set...");
try {
...
print("\n3. Initializing Shard 2 Replica Set...");
try {
...
try {
  ...
  // Add Shard 1
  result1 = sh.addShard("shard1RS/localhost:27018,localhost:27023,localhost:27024");
  print("Shard 1 added:", result1.ok ? "SUCCESS" : "FAILED");
  
  // Add Shard 2
  result2 = sh.addShard("shard2RS/localhost:27020,localhost:27025,localhost:27026");
